...
Main
	...
	STMEA SP!, {R4-R5, R1, R8-R10}	;PUSH parameters onto stack
...
SubrEA		;subroutine using an Empty-Ascending stack
	...
	LDMEA R5!, {R1-R4, R6-R7}    ;POP input and output parameters outof stack
...
*	...		;[R5] should NOT be changed/used for other purpose
	...
	STMEA R5!, {R1-R4, R6-R7}	;PUSH input and output parameters onto stack
